...
module.exports = class GoLiveBypassBD {
    ...
    scheduleServerProxyRecheck() {
        ...
        if (this._serverProxyWaitChecks >= 24) {
            this.sessionVerdict += " • nenhuma proxy válida após 2 min";
            return;
        }
    ...
    async verifyServerSessionAndRetry() {
        ...
        if (
            ...
            this.sessionVerdict =
                `BLOQUEADA pelo servidor (variantId ${assignment.variantId}) • aguardando proxy`;

            if (this._serverProxyWaitChecks === 0) {
                BdApi.UI.showToast(
                    "Go Live De Queijo: sessão bloqueada; procurando uma saída proxy válida.",
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.6.3"),
                React.createElement(
                    "div",
