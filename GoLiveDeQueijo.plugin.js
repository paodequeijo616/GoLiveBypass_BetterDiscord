...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.12 mantém a limpeza completa da integração, mas preserva o arquivo GoLiveDeQueijo.plugin.js no BetterDiscord."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.12"),
                React.createElement(
                    "div",
