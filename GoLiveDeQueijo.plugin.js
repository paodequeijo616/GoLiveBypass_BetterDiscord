...
module.exports = class GoLiveBypassBD {
    ...
    validateWireGuardConfig(file) {
        ...
        if (peers !== 1) {
            throw new Error(
                "v1.7.5 aceita exatamente 1 [Peer] por configuração"
            );
        }
    ...
    ensureWireGuardReady() {
        if (process.platform !== "win32") {
            throw new Error(
                "WireGuard automático da v1.7.5 suporta Windows"
            );
        }
    ...
    async installAndRestart() {
        try {
            ...
            BdApi.UI.alert(
                ...
                e.message +
                "\n\nA v1.7.5 executa a etapa elevada no processo nativo após o reinício do Discord."
            );
        }
    }
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "",
            "NOTA v1.7.5:",
            "Os dois logs da v1.7.5 confirmaram remote-stream com videoSupported=true e callback de primeiro frame instalado, mas nenhum frame chegou.",
            "Fechar/reabrir *.discord.media também não resolveu. Por isso a v1.7.5 testa outra hipótese: a sinalização *.discord.media passa pela mesma saída não-BR do Gateway.",
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.7.5"),
                React.createElement(
                    "div",
