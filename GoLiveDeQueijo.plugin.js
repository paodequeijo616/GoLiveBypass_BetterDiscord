...
module.exports = class GoLiveBypassBD {
    constructor() {
        ...
        this.settings = Object.assign({
            ...
            autoUpdate: TEST_BUILD_DISABLE_AUTO_UPDATE ? false : true,
    ...
    requestNativeFallback(
        ...
        if (
            ...
            this.log(
                `DIRECT ONLY: fallback ignorado (${String(reason || "sem motivo")})`
            );
    ...
    installVideoGuardPatch() {
        ...
        try {
            ...
            //
            // Nesta beta fazemos os DOIS patches ao mesmo tempo:
    ...
    async checkForUpdates(manual = false) {
        if (
            TEST_BUILD_DISABLE_AUTO_UPDATE &&
            !manual
        ) {
            this._updateStatus =
                "auto update desativado nesta beta";
        ...
        try {
            ...
            if (!TEST_BUILD_DISABLE_AUTO_UPDATE && this.settings.autoInstallUpdates) {
