...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.4 prioriza saídas dos EUA, mede RTT UDP real pelo SOCKS5 e mira até 200 ms; Canadá é fallback próximo e saídas distantes como CN/SG/TW não são mais selecionadas."
        ].join("\n");
    }
    ...
    getDiagnostic() {
        ...
        if (!status) {
            ...
            lines.push(
                `perfil: ${status.autoProxyProfile || "US-FIRST <=200ms"}`
            );
            lines.push(
    ...
    getSettingsPanel() {
            ...
            status?.singBoxProxy
                ...
                : (
                    status?.state === "auto-proxy-search"
                        ? "procurando EUA/Canadá com UDP ≤200ms..."
                        : "automática US-first"
                );
        ...
        const stateText = singBoxReady && proxyHealth?.ok === false
            ...
            : singBoxReady
                ? "TUN ATIVO • TCP + UDP"
                : autoSearching
                    ? `PROCURANDO US ≤200ms • ${status?.autoProxyTested || 0} TESTADAS`
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.4"),
                React.createElement(
                    "div",
            ...
            React.createElement(
                ...
                field(
                    "Saída TCP/UDP",
                    "Automática US-first. Mede UDP RTT real; alvo ≤200 ms. EUA têm prioridade, Canadá é fallback próximo. Ásia/Europa não são escolhidas.",
