...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.15 usa routes.json/routes.txt como snapshots prontos de proxies. O cliente não baixa dezenas de repositórios: baixa um catálogo central, testa UDP em massa e usa o JSON para país/latência."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.15"),
                React.createElement(
                    "div",
