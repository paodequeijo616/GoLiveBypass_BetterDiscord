...
module.exports = class GoLiveBypassBD {
    ...
    ensureSingBoxReady() {
        if (process.platform !== "win32") {
            throw new Error(
                "A integração sing-box TUN da v1.8.3 suporta Windows."
            );
        }
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.8.3 usa o sing-box stable atual, TUN stack=system e auto_detect_interface para reduzir loop de rota."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.8.3"),
                React.createElement(
                    "div",
