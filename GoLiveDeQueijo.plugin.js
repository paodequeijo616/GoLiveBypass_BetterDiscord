...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "",
            "NOTA v1.6.9:",
            "stream-auto = conexão promovida a stream porque getFilteredStats(2) confirmou vídeo outbound/screenshare.",
            "Se demand=true + captura/FPS de entrada avançam + framesEncoded/FPS de saída ficam parados por >=20s, o preload destrói somente a stream para o Discord renegociar."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.6.9"),
                React.createElement(
                    "div",
