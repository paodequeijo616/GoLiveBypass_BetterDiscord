...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v2.0.8 redesenha o Settings pós-ativação: controles, botões e cards consistentes, além de logs técnicos persistentes com abas."
        ].join("\n");
    }
