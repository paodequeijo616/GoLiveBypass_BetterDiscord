...
// Modo oficial DIRECT:
// mantém Go Live/câmera usando a conexão direta e não ativa
// fallback TUN/SOCKS automaticamente.
...
module.exports = class GoLiveBypassBD {
    ...
    requestNativeFallback(
        ...
        if (
            ...
            this.log(
                `DIRECT MODE: fallback ignorado (${String(reason || "sem motivo")})`
            );
