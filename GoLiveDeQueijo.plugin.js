...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.1 mantém a busca automática TCP+UDP, mas isola timeouts/erros de proxies mortas para que uma ETIMEDOUT nunca derrube o processo principal do Discord."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        const stateText = singBoxReady && proxyHealth?.ok === false
            ...
            : singBoxReady
                ? "TUN ATIVO • TCP + UDP"
                : autoSearching
                    ? `PROCURANDO UDP • ${status?.autoProxyTested || 0} TESTADAS`
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.1"),
                React.createElement(
                    "div",
            ...
            React.createElement(
                ...
                field(
                    "Saída TCP/UDP",
                    "Automática. O plugin baixa listas públicas, testa SOCKS5 CONNECT, UDP ASSOCIATE e país de saída e escolhe apenas uma opção não-BR que passe em tudo.",
