...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.10 mantém DIRECT-FIRST e faz FRESH RESET no startup: limpa todos os JSONs de cache/teste de rede, remove configuração SOCKS antiga e tenta encerrar qualquer TUN/sing-box residual antes do Discord conectar."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.10"),
                React.createElement(
                    "div",
