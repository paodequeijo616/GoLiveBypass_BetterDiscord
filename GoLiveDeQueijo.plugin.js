...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.0 procura automaticamente uma saída SOCKS5 pública não-BR que passe em TCP e UDP ASSOCIATE; não exige VPS, Proton ou proxy manual."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.0"),
                React.createElement(
                    "div",
