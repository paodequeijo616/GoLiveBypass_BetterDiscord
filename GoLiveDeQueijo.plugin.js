...
module.exports = class GoLiveBypassBD {
        ...
        try {
            ...
            fs.writeFileSync(
                ...
                JSON.stringify({
                    ...
                    forceViewerVideoSupported: this.settings.forceViewerVideoSupported !== false,
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "",
            "NOTA v1.6.10:",
            "remote-stream = createVoiceConnectionWithOptions com streamUserId; é a conexão usada para assistir à Live de outra pessoa.",
            "Se a remote-stream não entregar primeiro frame após ~6,5s, a recuperação fecha somente *.discord.media (close 4000) para o Discord renegociar voz/vídeo.",
            "O Gateway não é recarregado por essa recuperação."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.6.10"),
                React.createElement(
                    "div",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "button",
                        {
                            ...
                            onClick: () => plugin.requestViewerMediaRecovery()
                        },
                        "Reconectar mídia / assistir Live"
                    ),
                    React.createElement(
                        "button",
                        {
