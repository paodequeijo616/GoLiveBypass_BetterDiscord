...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.7 mantém um catálogo completo de proxies, prioriza países mais próximos do Brasil e remove o limite efetivo de 180 candidatos do modo automático."
        ].join("\n");
    }
    ...
    getSettingsPanel() {
        ...
        const stateText = singBoxReady && proxyHealth?.ok === false
            ...
            : singBoxReady
                ? "TUN ATIVO • TCP + UDP"
                : autoSearching
                    ? `PROCURANDO PERTO→LONGE • ${status?.autoProxyTested || 0}/${status?.autoProxyCandidates || "?"}`
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.7"),
                React.createElement(
                    "div",
            ...
            React.createElement(
                ...
                field(
                    "Saída TCP/UDP",
                    "Catálogo global persistente. Testa primeiro países mais próximos do Brasil, em paralelo. ≤150 ms usa na hora; as melhores válidas ficam em cache separado.",
