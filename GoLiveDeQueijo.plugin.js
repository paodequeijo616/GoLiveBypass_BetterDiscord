...
module.exports = class GoLiveBypassBD {
    constructor() {
        ...
        this.settings = Object.assign({
            ...
            manualProxy: "",
            networkMode: "singbox",
            singBoxProxy: "socks5://3.19.60.40:10100",
            voiceRegion: "",
        ...
        try {
            ...
            fs.writeFileSync(
                ...
                JSON.stringify({
                    ...
                    manualProxy: "",
                    networkMode: "singbox",
                    singBoxProxy: String(this.settings.singBoxProxy || ""),
    ...
    ensureSingBoxReady() {
        if (process.platform !== "win32") {
            throw new Error(
                "A integração sing-box TUN da v1.8.0 suporta Windows."
            );
        }
    ...
    async installAndRestart() {
        try {
            ...
            BdApi.UI.showToast(
                "Preparando sing-box TUN TCP/UDP do Discord...",
                {
                    type: "info",
                    timeout: 7000
                }
            ...
            BdApi.UI.showToast(
                `Proxy ${prepared.proxy.safe} • hook instalado em ${target.appName}. ` +
                "Reiniciando para solicitar UAC e subir o TUN...",
                {
                    type: "success",
                    timeout: 8000
                }
            ...
            this.api.Logger.error(
                "Falha ao preparar sing-box/reiniciar",
                e
            );

            BdApi.UI.alert(
                PLUGIN_NAME,
                "Não consegui preparar o sing-box:\n\n" +
                e.message
            );
        }
    }
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "O SOCKS5 do sing-box habilita TCP e UDP por padrão. A 3proxy precisa aceitar UDP ASSOCIATE e o firewall/NAT da VPS precisa permitir o relay UDP.",
            "A v1.8.0 usa stack=system e dns_mode=disabled para reduzir interferência no restante do Windows."
        ].join("\n");
    }
    ...
    getDiagnostic() {
        ...
        if (!status) {
            ...
            lines.push(
                `proxy: ${status.singBoxProxy || (() => {
                    try {
                        return this.parseSingBoxProxy().safe;
                    } catch {
                        return "-";
                    }
                })()}`
    ...
    getSettingsPanel() {
        ...
        try {
            safeProxy =
                this.parseSingBoxProxy().safe;
        } catch {}

        const stateText = singBoxReady
            ? "ATIVO • TCP + UDP"
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.8.1"),
                React.createElement(
                    "div",
            ...
            React.createElement(
                ...
                field(
                    "Proxy SOCKS5 TCP/UDP",
                    "O sing-box TUN envia somente os processos do Discord por esta SOCKS5. Padrão atual: socks5://3.19.60.40:10100.",
