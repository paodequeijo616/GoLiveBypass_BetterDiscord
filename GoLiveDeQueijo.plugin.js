...
module.exports = class GoLiveBypassBD {
    ...
    getFullDiagnostic() {
        ...
        return [
            ...
            "A v1.9.5 pesquisa globalmente todos os países permitidos, escolhe imediatamente saídas com UDP RTT <=150 ms, prefere <=200 ms e salva as melhores em best-proxies.json."
        ].join("\n");
    }
    ...
    getDiagnostic() {
        ...
        if (!status) {
            ...
            lines.push(
                `perfil: ${status.autoProxyProfile || "GLOBAL <=200ms / instant <=150ms"}`
            );
            lines.push(
    ...
    getSettingsPanel() {
            ...
            status?.singBoxProxy
                ...
                : (
                    status?.state === "auto-proxy-search"
                        ? "procurando globalmente • alvo ≤200ms..."
                        : "automática global"
                );
        ...
        const stateText = singBoxReady && proxyHealth?.ok === false
            ...
            : singBoxReady
                ? "TUN ATIVO • TCP + UDP"
                : autoSearching
                    ? `PROCURANDO GLOBAL ≤200ms • ${status?.autoProxyTested || 0} TESTADAS`
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("h2", {style: {margin: 0}}, "Go Live De Queijo v1.9.5"),
                React.createElement(
                    "div",
            ...
            React.createElement(
                ...
                field(
                    "Saída TCP/UDP",
                    "Automática global. Procura qualquer país permitido, seleciona imediatamente se achar UDP ≤150 ms, prefere ≤200 ms e testa primeiro as melhores proxies já salvas.",
